...
func (e CapabilityItemKind) Valid() bool {
	switch e {
	case CapabilityItemKindCapabilityItem:
		return true
	default:
		return false
	}
...
func (e CapabilityListKind) Valid() bool {
	switch e {
	case CapabilityListKindCapabilityList:
		return true
	default:
		return false
	}
...
func (e DataKeyListKind) Valid() bool {
	switch e {
	case DataKeyListKindDataKeyList:
		return true
	default:
		return false
	}
...
func (e HardwareItemKind) Valid() bool {
	switch e {
	case HardwareItemKindHardwareItem:
		return true
	default:
		return false
	}
...
func (e HardwareListKind) Valid() bool {
	switch e {
	case HardwareListKindHardwareList:
		return true
	default:
		return false
	}
...
func (e IPAddressItemKind) Valid() bool {
	switch e {
	case IPAddressItemKindIPAddressItem:
		return true
	default:
		return false
	}
...
func (e InstanceItemKind) Valid() bool {
	switch e {
	case InstanceItemKindInstanceItem:
		return true
	default:
		return false
	}
...
func (e InstanceListKind) Valid() bool {
	switch e {
	case InstanceListKindInstanceList:
		return true
	default:
		return false
	}
...
func (e KeywordDefinitionListKind) Valid() bool {
	switch e {
	case KeywordDefinitionListKindKeywordDefinitionList:
		return true
	default:
		return false
	}
...
func (e KeywordListKind) Valid() bool {
	switch e {
	case KeywordListKindKeywordList:
		return true
	default:
		return false
	}
...
func (e NetworkIPListKind) Valid() bool {
	switch e {
	case NetworkIPListKindNetworkIPList:
		return true
	default:
		return false
	}
...
func (e ObjectFrozen) Valid() bool {
	switch e {
	case ObjectFrozenFrozen:
		return true
	case ObjectFrozenMixed:
		return true
	case ObjectFrozenNa:
		return true
	case ObjectFrozenUnfrozen:
		return true
	default:
		return false
	}
...
func (e PackageItemKind) Valid() bool {
	switch e {
	case PackageItemKindPackageItem:
		return true
	default:
		return false
	}
...
func (e PackageListKind) Valid() bool {
	switch e {
	case PackageListKindPackageList:
		return true
	default:
		return false
	}
...
func (e PlacementState) Valid() bool {
	switch e {
	case PlacementStateNa:
		return true
	case PlacementStateNonOptimal:
		return true
	case PlacementStateOptimal:
		return true
	case PlacementStateUndef:
		return true
	default:
		return false
	}
...
func (e PropertyListKind) Valid() bool {
	switch e {
	case PropertyListKindPropertyList:
		return true
	default:
		return false
	}
...
func (e Provisioned) Valid() bool {
	switch e {
	case ProvisionedFalse:
		return true
	case ProvisionedMixed:
		return true
	case ProvisionedNa:
		return true
	case ProvisionedTrue:
		return true
	default:
		return false
	}
...
func (e RelayStatusListKind) Valid() bool {
	switch e {
	case RelayStatusListKindRelayStatusList:
		return true
	default:
		return false
	}
...
func (e ResourceInfoListKind) Valid() bool {
	switch e {
	case ResourceInfoListKindResourceInfoList:
		return true
	default:
		return false
	}
...
func (e ResourceItemKind) Valid() bool {
	switch e {
	case ResourceItemKindResourceItem:
		return true
	default:
		return false
	}
...
func (e ResourceListKind) Valid() bool {
	switch e {
	case ResourceListKindResourceList:
		return true
	default:
		return false
	}
...
func (e SANPathInitiatorItemKind) Valid() bool {
	switch e {
	case SANPathInitiatorItemKindSANPathInitiatorItem:
		return true
	default:
		return false
	}
...
func (e SANPathInitiatorListKind) Valid() bool {
	switch e {
	case SANPathInitiatorListKindSANPathInitiatorList:
		return true
	default:
		return false
	}
...
func (e SANPathListKind) Valid() bool {
	switch e {
	case SANPathListKindSANPathList:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the Topology enum.
func (e Topology) Valid() bool {
	switch e {
	case Failover:
		return true
	case Flex:
...
const (
	Debug PostDaemonAuditParamsLevel = "debug"
	Error PostDaemonAuditParamsLevel = "error"
	Info  PostDaemonAuditParamsLevel = "info"
	Trace PostDaemonAuditParamsLevel = "trace"
	Warn  PostDaemonAuditParamsLevel = "warn"
)
...
// ArrayItem defines model for ArrayItem.
type ArrayItem struct {
	Name string `json:"name"`
	Type string `json:"type"`
}

// ArrayItems defines model for ArrayItems.
type ArrayItems = []ArrayItem
